...
{
	if(parsethis == "true" || parsethis == "yes" || parsethis == "y" || parsethis == "on" || parsethis == "enable" || parsethis == "show")
		return true;
	else if(parsethis == "false" || parsethis == "no" || parsethis == "n" || parsethis == "off" || parsethis == "disable" || parsethis == "hide")
		return false;
