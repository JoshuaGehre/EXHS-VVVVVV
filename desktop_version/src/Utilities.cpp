...
script_exception::script_exception(const char* msg, bool raw /* = false*/) :
	script_exception(std::string(msg), raw) {}
...
script_exception::script_exception(const std::exception& ex) :
	script_exception(ex.what()) {}
